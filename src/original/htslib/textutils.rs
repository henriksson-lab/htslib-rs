use crate::htslib_mini_rs::hts::{hFILE, hts_json_token, kstring_t};
...
pub unsafe fn textutils_c_164_fscan_string(fp: *mut hFILE, d: *mut kstring_t) -> c_int {
    ...
    loop {
        let mut c = crate::htslib_mini_rs::hfile::htslib_hfile_h_163_hgetc(fp);
        if c == libc::EOF {
            break;
        }
        ...
        match c as u8 {
            b'\\' => {
                c = crate::htslib_mini_rs::hfile::htslib_hfile_h_163_hgetc(fp);
                if c == libc::EOF {
                ...
                match c as u8 {
                    b'b' => {
                        e |= (crate::htslib_mini_rs::hts::kputc(b'\x08' as c_int, d) < 0) as u32
                    }
                    b'f' => {
                        e |= (crate::htslib_mini_rs::hts::kputc(b'\x0c' as c_int, d) < 0) as u32
                    }
                    b'n' => e |= (crate::htslib_mini_rs::hts::kputc(b'\n' as c_int, d) < 0) as u32,
                    b'r' => e |= (crate::htslib_mini_rs::hts::kputc(b'\r' as c_int, d) < 0) as u32,
                    b't' => e |= (crate::htslib_mini_rs::hts::kputc(b'\t' as c_int, d) < 0) as u32,
                    b'u' => {
                        c = crate::htslib_mini_rs::hfile::htslib_hfile_h_163_hgetc(fp);
                        if c != libc::EOF {
                            ...
                            if d1 >= 0 {
                                ...
                                if c != libc::EOF {
                                    ...
                                    if d2 >= 0 {
                                        c = crate::htslib_mini_rs::hfile::htslib_hfile_h_163_hgetc(
                                            fp,
                                        );
                                        if c != libc::EOF {
                    ...
                    _ => e |= (crate::htslib_mini_rs::hts::kputc(c, d) < 0) as u32,
                }
            }
    ...
    loop {
        ...
        match c {
            ...
            _ => {
                ...
                while crate::htslib_mini_rs::hfile::hpeek(fp, (&mut peek as *mut c_char).cast(), 1)
                    == 1
                    && !matches!(
                        peek as u8,
                        b' ' | b'\t' | b'\r' | b'\n' | b',' | b']' | b'}'
