...
pub unsafe fn test_test_bcf_set_variant_type_c_42_test_bcf_set_variant_type() {
    ...
    if var1.type_ != crate::htslib_rs::vcf::VCF_SNP as c_int {
    ...
    if var2a.type_ != (crate::htslib_rs::vcf::VCF_INDEL | vcf::VCF_INS) as c_int {
    ...
    if var2b.type_ != (crate::htslib_rs::vcf::VCF_INDEL | vcf::VCF_DEL) as c_int {
    ...
    if var3a.type_ != crate::htslib_rs::vcf::VCF_BND as c_int {
    ...
    if var3b.type_ != crate::htslib_rs::vcf::VCF_BND as c_int {
        test_test_bcf_set_variant_type_c_32_error(
            c"N[16:33625444[ was not detected as a breakend".as_ptr(),
        );
    }
    ...
    if var3c.type_ != crate::htslib_rs::vcf::VCF_BND as c_int {
        test_test_bcf_set_variant_type_c_32_error(
    ...
    if var3d.type_ != crate::htslib_rs::vcf::VCF_BND as c_int {
        test_test_bcf_set_variant_type_c_32_error(
            c"[16:33625444[N was not detected as a breakend".as_ptr(),
        );
    }
    ...
    if var4a.type_ != crate::htslib_rs::vcf::VCF_REF as c_int {
        test_test_bcf_set_variant_type_c_32_error(
    ...
    if var4b.type_ != crate::htslib_rs::vcf::VCF_REF as c_int {
        test_test_bcf_set_variant_type_c_32_error(
    ...
    if var5.type_ != crate::htslib_rs::vcf::VCF_MNP as c_int {
    ...
    if var6.type_ != crate::htslib_rs::vcf::VCF_OVERLAP as c_int {
    ...
    if var7.type_ != crate::htslib_rs::vcf::VCF_REF as c_int {
        test_test_bcf_set_variant_type_c_32_error(
