...
fn kbs_words(bs: &kbitset_t) -> *mut libc::c_ulong {
...
pub unsafe fn kbs_exists(bs: &kbitset_t, i: c_int) -> c_int {
...
pub unsafe fn kbs_next(bs: &kbitset_t, itr: &mut kbitset_iter_t) -> c_int {
    let words = kbs_words(bs);
